...
public class Function extends Base {
    ...
    public String toString() {
        return super.toString()+"Function [functionCode=" + functionCode + ", functionName="
                + functionName + ", creationTime=" + creationTime
                + ", createdBy=" + createdBy + ", lastUpdateTime="
                + lastUpdateTime + ", funcUrl=" + funcUrl + ", isStart="
                + isStart + ", parentId=" + parentId + "]";
    }
