...
<div class="mbxnav">
    ...
    系统配置管理\
    <a href="/SystemConfig/clienttype.do">客户类型</a>
...
<div class="container" id="app">  <!-- 每一项都包含在 container中   分7项    根据 type显示-->
    ...
    <div>
        <div class="addSystemConfig">
            <input type="button" id="addsystemconfig"  @click="openAddDiv()" value="添加客户类型"/>
        </div>
        <!-- 添加的方法 -->
...
<script type="text/javascript" src="/js/systemconfig/clienttype.js"></script>
<script>
    $(function(){
        mover(5);
    })
